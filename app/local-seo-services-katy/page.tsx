...
export const metadata: Metadata = {
  ...
  description:
    'Expert local SEO services in Katy, TX. Google Maps ranking, GBP optimization, citations & more. Most clients see results in 60-90 days.',
...
const services = [
  {
    ...
    icon: Award,
    description:
      "Your Google Business Profile is the single most important factor in local search rankings — and most Katy businesses have it set up wrong. I audit every field: business categories, service areas, attributes, hours, Q&A, photos, and posts. The wrong primary category alone can cost you dozens of ranking positions. After optimization, your GBP sends the exact signals Google needs to put you in the Map Pack for searches in Katy, TX and surrounding Fort Bend County areas.",
  },
  {
    title: 'Local Citation Building & Cleanup',
    icon: CheckCircle,
    description:
      'Inconsistent NAP (Name, Address, Phone) data across directories is one of the fastest ways to hurt your local rankings. I build new citations on the 50+ directories that matter most for Katy businesses and clean up existing inconsistencies that are sending mixed signals to Google. This includes industry-specific directories for HVAC, dental, legal, restaurants, and other Katy business types — not just generic ones every agency builds.',
  },
  {
    title: 'On-Page Local SEO',
    icon: TrendingUp,
    description:
      "Your website needs to tell Google's algorithm exactly where you are and what you serve. I optimize your homepage and service pages with proper schema markup, geo-targeted title tags, local content signals, and internal linking structure. Most Katy business websites I audit are missing at least 5 critical on-page signals. Fixing them typically takes 2-3 weeks and produces movement within 30-45 days — often faster than profile work alone.",
  },
  {
    title: 'Local Link Building',
    icon: TrendingUp,
    description:
      "Links from other Katy and Fort Bend County websites tell Google your business has real local authority. I build these through legitimate outreach: local business associations, Fort Bend Chamber of Commerce listings, Katy-area news sites, and industry partners. This isn't buying links — it's earning them from the kinds of local sources Google actually trusts for Map Pack rankings.",
  },
  {
    title: 'Review Generation & Management',
    icon: Users,
    description:
      "Google reviews are a direct ranking factor for local search. But beyond rankings, they're what converts a searcher into a customer. I set up a repeatable system to generate reviews from your real Katy customers — without violating Google's guidelines. I also monitor and help you respond to reviews in ways that reinforce your local authority. Most clients double their review count within 90 days using the system I build for them.",
  },
]
...
const quickFacts = [
  ...
  { value: 'Top 3', label: 'Average Map Pack improvement' },
]

export default function LocalSeoServicesPage() {
  const serviceSchema = generateServiceSchema(
    'Local SEO Services Katy TX',
    'Expert local SEO services for Katy, TX businesses including Google Business Profile optimization, local citation building, on-page SEO, local link building, and review management.',
  ...
  return (
    <>
      ...
      <div className="pt-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <section className="direct-answer">
            <p className="text-text-main text-base leading-relaxed">
              ...
              your business show up on Google Maps and in local search results when customers in
              Katy, TX search for what you offer. Unlike general SEO, these services focus
              specifically on the signals Google uses to rank local businesses — your Google
              Business Profile, local citations, reviews, and geo-targeted website content.
            </p>
          </section>
          ...
          <p className="text-text-main text-base leading-relaxed mb-4">
            ...
            digital marketing menu, but as my entire focus. That specialization matters. The search
            landscape in Fort Bend County is different from Sugar Land, which is different from
            central Houston. I know which categories are over-saturated in Katy, where the
            citation gaps are, and how competitive the Map Pack is for your specific industry.
          </p>
          <p className="text-text-main text-base leading-relaxed mb-8">
            Most clients who come to me have tried generic SEO agencies and gotten generic results.
            When your whole business depends on showing up for searches in a 10-mile radius, you
            need someone who works that specific geography every day. That&apos;s what I do.
          </p>
        </div>

        <div className="bg-slate-50 border-y border-border py-10 mb-12">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="font-serif text-2xl text-primary font-bold text-center mb-6">
              Quick Facts
            </h2>
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-text-main text-base leading-relaxed">{service.description}</p>
                  </div>
                </div>
              </div>
            ))}
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
          <div className="quick-facts-box">
            ...
            <ul className="space-y-3">
              {[
                { period: 'Days 1-14', action: 'Full audit of GBP, citations, on-page signals, and competitor gaps' },
                { period: 'Days 15-30', action: 'GBP optimization, citation corrections, and on-page fixes go live' },
                { period: 'Days 31-60', action: 'Citation building continues, review system implemented, content updated' },
                { period: 'Days 61-90', action: 'Ranking movement visible; link building and review velocity increase' },
                { period: 'Monthly', action: 'Reporting, ongoing optimization, adapting to algorithm changes' },
              ].map((item) => (
                <li key={item.period} className="flex gap-3 items-start">
                  <span className="text-accent font-semibold text-sm w-24 flex-shrink-0 pt-0.5">
                    {item.period}
                  </span>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-14">
          <p className="text-muted text-sm text-center">
            Also explore:{' '}
            <Link href="/google-maps-seo-houston" className="text-accent hover:underline">
              Google Maps SEO for Houston &amp; Katy
            </Link>{' '}
            |{' '}
            <Link href="/local-seo-expert-katy" className="text-accent hover:underline">
              About the Local SEO Expert
            </Link>{' '}
            |{' '}
      ...
      <CTABanner
        ...
        subtext="Free local SEO audit — I'll review your GBP, rankings, and competitors and tell you what needs fixing. No obligation."
