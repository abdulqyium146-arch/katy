...
const nextSteps = [
  {
    ...
    description:
      "I personally review every request — no assistant, no intake team. You'll hear back within 48 business hours.",
  },
  {
    step: '2',
    title: 'Free audit delivered',
    description:
      'I pull your current rankings, GBP health, citation gaps, and top competitor data. You get a clear picture of where you stand.',
  },
  {
    step: '3',
    title: 'Straight talk on next steps',
    description:
      "If there's a clear path to ranking your Katy business higher, I'll tell you what it is, what it costs, and how long it takes.",
  },
]
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 py-8">
          ...
          <div>
            ...
            <p className="text-muted text-base leading-relaxed mb-8">
              I&apos;ll review your GBP, local rankings, and top competitors — and tell you
              exactly what&apos;s holding you back. No sales pitch. Just data.
            </p>
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4" noValidate>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="fullName" className="block text-sm font-semibold text-primary mb-1.5">
                  ...
                  <div>
                    <label htmlFor="businessName" className="block text-sm font-semibold text-primary mb-1.5">
                ...
                <div>
                  <label htmlFor="website" className="block text-sm font-semibold text-primary mb-1.5">
                ...
                <div>
                  <label htmlFor="challenge" className="block text-sm font-semibold text-primary mb-1.5">
                  ...
                  <textarea
                    ...
                    placeholder="e.g. We don't show up on Google Maps, competitors rank above us, fewer calls this year..."
                ...
                <button
                  ...
                  className="w-full sm:w-auto px-7 py-3.5 bg-accent text-white font-bold text-base rounded-lg hover:bg-blue-700 transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
                >
                  {loading ? 'Sending...' : 'Send My Audit Request'}
                </button>
                <p className="text-muted text-xs">No spam. No commitment. Response within 48 business hours.</p>
              </form>
            )}
          </div>
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="bg-white border border-border rounded-xl p-6 shadow-card">
              <h2 className="font-sans font-bold text-primary text-lg mb-4">Contact Information</h2>
              <div
              ...
              >
                ...
                <div className="flex items-start gap-3">
                  ...
                  >
                    <strong>Local SEO Experts Katy</strong><br />
                ...
                <div className="flex items-center gap-3">
                  ...
                  <a href="tel:+18320000000" itemProp="telephone" className="text-text-main text-sm hover:text-accent transition-colors">
                    (832) 000-0000
                  </a>
                </div>
                <div className="flex items-center gap-3">
                  <Mail size={15} className="text-accent flex-shrink-0" />
                  <a href="mailto:info@localseoexpertskaty.com" itemProp="email" className="text-text-main text-sm hover:text-accent transition-colors">
            ...
            <div className="bg-white border border-border rounded-xl overflow-hidden shadow-card">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d110837.44785!2d-95.8244!3d29.7858!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8640d98e9f1a8fd7%3A0x8e6b8e3e1e1b1e1b!2sKaty%2C+TX+77494!5e0!3m2!1sen!2sus!4v1700000000000"
            ...
            <div className="bg-primary rounded-xl p-6">
              <h3 className="font-sans font-bold text-white text-base mb-4">What Happens After You Submit</h3>
